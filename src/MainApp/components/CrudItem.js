...
export default function CrudItem({name, price, img, description, id, setItemData}){
    ...
    return <div className="flex max-w-screen px-2 pb-2">
        ...
        <input type="text" defaultValue={name} /* value={item.name} */ onChange={(e)=>{updateName(e)}} className="text-gray-700 p-1 focus:bg-gray-200 bg-gray-100 outline-none text-center focus:outline border-y w-12 sm:w-32 text-xs border-green-400 overflow-hidden h-10">
        </input>
