...
export default function CrudComponent(){
    ...
    const loaderIcon = <svg role="status" class="mr-2 w-24 h-24 text-gray-200 animate-spin dark:text-gray-600 fill-green-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return <div>
      ...
      <div className="flex flex-col justify-center items-center">
        {ItemArray ? ItemArray : <div className="flex justify-center align-center">{loaderIcon}</div>}
      </div>
    </div>
}