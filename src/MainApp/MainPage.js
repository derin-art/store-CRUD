...
export default function MainPage({ user }) {
  ...
  return user.status === 200 ? (
    <>
      <div
        className="h-2 bg-gray-100 border fixed w-screen mb-4 pb-16"
        style={
          scrollPosition > 5.5 ? { boxShadow: "1px 1px 30px #D3D3D3" } : {}
        }
      ></div>
            ...
            <>
              ...
              <div className="sm:h-screen sm:w-screen p-2 pt-10">
                <div>
                  {
                    <div
                      className={`items-start mt-8 flex overflow-x-auto pb-4 ${previewWidth()} sm:w-full justify-center`}
                    >
                      ...
                      {previewMode ? (
                        <div className="flex justify-center items-center mr-2 pb-6 sm:pt-5 pt-3">
                          {" "}
